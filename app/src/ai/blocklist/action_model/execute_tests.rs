...
mod read_file_failures {
    ...
    use super::super::{describe_failed_files, read_local_file_context, ReadFilesFailedFile};
    ...
    fn describe_failed_files_groups_each_reason_per_file() {
        ...
        assert!(
            summary.contains("/tmp/broken.png: File could not be processed as an image"),
            "got: {summary}"
        );
    }
}

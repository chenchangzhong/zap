...
workspace-toast-conversations-deleted = 会話を { $count } 件削除しました
workspace-toast-all-conversations-deleted = すべての会話を削除しました
...
workspace-conversation-delete-confirm-title = 「{ $title }」を削除しますか?
workspace-conversation-delete-confirm-title-multiple = { $count } 件の会話を削除しますか?
workspace-conversation-delete-confirm-title-all = すべての会話を削除しますか?
workspace-conversation-delete-confirm-title-default = 会話を削除しますか?
workspace-conversation-delete-confirm-description = この会話は完全に削除され、元に戻すことはできません。
workspace-conversation-delete-confirm-description-multiple = これらの会話は完全に削除され、元に戻すことはできません。
workspace-conversation-delete-confirm-description-all = すべての会話が完全に削除され、元に戻すことはできません。
workspace-conversation-list-select = 選択
workspace-conversation-list-delete-all = すべて削除
workspace-conversation-list-cancel = キャンセル
workspace-conversation-list-select-all = すべて選択
workspace-conversation-list-delete-selected = 削除 ({ $count })
workspace-conversation-list-delete-in-progress-error = 進行中の会話は削除できません。
workspace-conversation-list-delete-all-partial = 一部の会話は削除されませんでした(進行中またはアンビエントエージェントの会話)。
